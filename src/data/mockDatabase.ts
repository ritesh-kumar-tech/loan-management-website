...
export const defaultSettings: CompanySettings = {
  companyName: 'Dhani Finances',
  tagline: 'Fast, convenient and affordable online personal loan support',
  logoUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=120&h=120&fit=crop&auto=format',
  supportPhone: '+91-9007172770',
  supportEmail: 'support@dhanifinances.org',
  whatsappNumber: '+91-9007172770',
  registeredAddress: 'Subhadra Bhavan, 1st floor, opp. Ramee Grand Hotel, Apte Rd, Deccan Gymkhana, Pune, Maharashtra 411005',
  branchAddress: 'Subhadra Bhavan, 1st floor, opp. Ramee Grand Hotel, Apte Rd, Deccan Gymkhana, Pune, Maharashtra 411005',
  upiId: 'dhanifinance@paytm',
  upiAccountName: 'Dhani Finances - Loan Collection',
  ...
  collectionBankName: 'South Indian Bank',
  collectionAccountNumber: '0555053000003669',
  collectionIfscCode: 'SIBL0000555',
  collectionAccountHolderName: 'Dhani Finances - Loan Collection',
  authorizedSignatoryName: 'Grievance Redressal Cell',
  authorizedSignatoryTitle: 'Customer Support and Grievance Desk',
...
export const defaultLoanProducts: LoanProduct[] = [
  {
    ...
    tagline: 'Fast personal funds with simple documentation',
    description: 'Collateral-free personal loans up to ₹25 Lakhs with simple documentation and transparent eligibility review.',
    iconName: 'UserCheck',
    minAmount: 25000,
    maxAmount: 2500000,
    minInterestRate: 6,
  ...
  },
  {
    ...
    type: 'business',
    title: 'Business Loan',
    tagline: 'Finance support for traders, MSMEs and entrepreneurs',
  ...
  },
  {
    ...
    tagline: 'Short-tenure finance for urgent needs',
  ...
  },
  {
    ...
    tagline: 'Support for higher studies in India and overseas',
...
export const defaultCmsContent: any = {
  ...
  statistics: [
    ...
    { id: 'stat_apps', label: 'Applications Processed', value: 10000, suffix: '+', iconName: 'FileCheck2', isActive: true },
    { id: 'stat_docs', label: 'Documents Verified', value: 500, suffix: '+', iconName: 'ShieldCheck', isActive: true },
    { id: 'stat_support', label: 'Support Requests Resolved', value: 10000, suffix: '+', iconName: 'Headphones', isActive: true },
  ],
  faqs: [
    {
      id: 'faq_1',
  ...
  testimonials: [
    {
      ...
      rating: 5,
      comment: 'The application flow was simple, and the team kept me updated through every step.',
      city: 'Gurugram',
      isVerified: true,
      isPublished: true,
      displayOrder: 1,
    },
    {
      ...
      rating: 5,
      comment: 'Clear EMI details and quick support helped me complete my business loan application smoothly.',
      city: 'Delhi',
      isVerified: true,
      isPublished: true,
      displayOrder: 2,
    },
    {
      ...
      loanType: 'Personal Loan',
      rating: 5,
      comment: 'I liked the transparent process and fast response after submitting my details online.',
      city: 'Mumbai',
      isVerified: true,
      isPublished: true,
      displayOrder: 3,
